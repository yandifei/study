...
if __name__ == '__main__':
    # 注意： 测试的短信模板编号为1
    sendTemplateSMS('15732622380', ['123456', 5], 1)
    # sendTemplateSMS('17611253691', ['123456', 5], 1)

    CCP().send_template_sms('15732622380', ['123456', 5], 1)
    # CCP().send_template_sms('17611253691', ['123456', 5], 1)