...
BankTypeError = message("题库类型未选择", "题库类型为空，请选择题库类型")
FilelrdErrorX=message("上传题库文件格式错误", "上传题库文件格式错误，第一行无标题：例如：问题	答案	选项一	选项二	"+
                      "选项三	选项四	问题图片链接	问题音频链接	问题来源")
BankNameNotFound=message("题库名称空", "题库名称空，请輸入题库名称")