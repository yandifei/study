...
class CompetitionQAInfo(CreateUpdateMixin):
    ...
    # 问题答案相关
    qsrecord = models.TextField(_('问题记录'), max_length=3000, blank=True, null=True, help_text=u'问题记录')
    asrecord = models.TextField(_('答案记录'), max_length=3000, blank=True, null=True, help_text=u'答案记录')
    aslogrecord = models.TextField(_('答案提交记录'), max_length=3000, blank=True, null=True, help_text=u'答案提交记录')
    ...
    correct_list = models.CharField(_(u'正确答案列表'), max_length=3000, blank=True, null=True, help_text=u'正确答案列表')
    wrong_list = models.CharField(_(u'错误答案列表'), max_length=3000, blank=True, null=True, help_text=u'错误答案列表')
