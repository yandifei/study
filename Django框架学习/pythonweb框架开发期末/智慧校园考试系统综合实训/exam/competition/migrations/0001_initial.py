# Generated by Django 2.1 on 2025-12-17 02:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_id', models.CharField(blank=True, db_index=True, help_text='商家账户唯一标识', max_length=32, null=True, verbose_name='商家id')),
                ('bank_name', models.CharField(blank=True, help_text='题库名称', max_length=40, null=True, verbose_name='题库名称')),
                ...
                ('bank_type', models.IntegerField(choices=[(0, '技术类'), (1, '教育类'), (2, '文化类'), (3, '常识类'), (6, '地理类'), (7, '体育类'), (4, '面试题')], default=0, help_text='题库类型', verbose_name='题库类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='创建时间', verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='更新时间', verbose_name='更新时间')),
                ('status', models.IntegerField(choices=[(0, '未完成'), (1, '已完成'), (2, '超时')], default=0, help_text='答题状态', verbose_name='答题状态')),
                ...
                ('uid', models.CharField(blank=True, db_index=True, help_text='用户唯一标识', max_length=32, null=True, verbose_name='用户id')),
                ('qsrecord', models.TextField(blank=True, help_text='问题记录', max_length=3000, null=True, verbose_name='问题记录')),
                ('asrecord', models.TextField(blank=True, help_text='答案记录', max_length=3000, null=True, verbose_name='答案记录')),
                ('aslogrecord', models.TextField(blank=True, help_text='答案提交记录', max_length=3000, null=True, verbose_name='答案提交记录')),
                ...
                ('correct_list', models.CharField(blank=True, help_text='正确答案列表', max_length=3000, null=True, verbose_name='正确答案列表')),
                ('wrong_list', models.CharField(blank=True, help_text='错误答案列表', max_length=3000, null=True, verbose_name='错误答案列表')),
                ('total_num', models.IntegerField(default=0, help_text='总共数量', verbose_name='总数')),
                ('score', models.FloatField(default=0, help_text='分数', verbose_name='得分')),
            ],
            options={
                'verbose_name': '比赛问题记录',
